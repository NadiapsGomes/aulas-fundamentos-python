...
qtd_a = frase.count('A') # Quantas vezes aparece a letra “A”;
print(f'O A aparece {qtd_a} vezes.')

p_posicao = frase.find('A') #✓ Em que posição aparece a primeira vez;
print(f'Aparece pela primeira vez na posição {p_posicao + 1}.')

u_posicao = frase.rfind('A') #✓ Em que posição aparece a última vez.
